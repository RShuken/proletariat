...
describe('PRLT-1224: Layer 1 — Claude Code lifecycle hooks', () => {
  ...
  describe('buildHookWrapperScript (TKT-009)', () => {
    ...
    it('should provide a basic check fallback when no tools available', () => {
      // Falls back to checking first character is { or [
    ...
    it('should output JSON directly when no command given', () => {
      expect(script).to.include('echo "$INPUT"')
    })
  })
})
